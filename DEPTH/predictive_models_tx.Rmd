...
```{r}
caretTrain(dat, 'svmRadial', 100)
```

## test LASSO
```{r}
caretTrain(dat, 'lasso', 100)
```

## test elastic net
```{r}
caretTrain(dat, 'enet', 100)
```

## test stochastic gradient boosting
```{r}
caretTrain(dat, 'gbm', 100)
```

## test extreme gradient boosting
```{r}
caretTrain(dat, 'xgbDART', 100)
```
